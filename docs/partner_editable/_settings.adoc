...
:partner-contributors: Cheon Jong Hyun, {partner-company-name}
:quickstart-contributors: Troy Ameigh and Dave May, {quickstart-team-name}, and Jekwang Ryu, YeonJoo Kwon, and SangYoul Jin, Amazon Professional Services organization
...
:default_deployment_region: ap-northeast-2
