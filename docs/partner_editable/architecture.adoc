...
* Amazon Simple Storage Service (Amazon S3) buckets for centralized logging and AWS WAF.
...
* The AWS Secrets Manager for creating and rotating the database password. 